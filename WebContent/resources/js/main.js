  ...
  $(document).ready(function(){
	    ...
	    var theUI = {
	      nodes:{"a":{color:"red", shape:"dot", alpha:1}, 
	             ...
	             b:{color:CLR.branch, shape:"dot", alpha:1}, 
	             c:{color:CLR.demo, alpha:1},
	             d:{color:CLR.demo, alpha:1},
	             e:{color:CLR.demo, alpha:1},

	             f:{color:CLR.branch, shape:"dot", alpha:1}, 
	             g:{color:CLR.doc, alpha:1},
	             h:{color:CLR.doc, alpha:1},

	             i:{color:CLR.branch, shape:"dot", alpha:1},
	             j:{color:CLR.code, alpha:1},
	             "j":{color:CLR.code, alpha:1},
	             "k":{color:CLR.code, alpha:1}
	            },
	      edges:{
	        "a":{
	          b:{length:.8},
